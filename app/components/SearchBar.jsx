...
import { searchProducts, formatPrice, getCategoryShort } from "../products/product";
              ...
              {results.map((tour) => (
                <li key={tour.id}>
                  <Link
                    ...
                    onClick={select}
                    className="flex items-center gap-3 rounded-xl p-2 transition hover:bg-palm-50"
                  >
                    <span className="relative h-12 w-14 shrink-0 overflow-hidden rounded-lg bg-ink/5">
                      <Image
                        src={tour.image}
                        alt=""
                        fill
                    ...
                    <span className="min-w-0 flex-1">
                      ...
                      <span className="text-xs text-ink/50">
                        ...
                        <span className="font-semibold text-palm-700">
