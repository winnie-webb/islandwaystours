          ...
          <div key={item.q}>
            <h3>
              <button
                ...
                className="flex w-full items-center justify-between gap-6 px-6 py-5 text-left transition-colors hover:bg-palm-50/60"
              >
                ...
                <span
                  className={`grid h-8 w-8 shrink-0 place-items-center rounded-full transition-all duration-300 ${
                    isOpen ? "rotate-45 bg-palm-600 text-white" : "bg-ink/5 text-ink/60"
                  }`}
                >
